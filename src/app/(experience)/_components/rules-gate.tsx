    ...
    >
      <AlertDialog.Portal>
        ...
        <AlertDialog.Popup className="fixed top-1/2 left-1/2 z-50 w-[min(90vw,380px)] -translate-x-1/2 -translate-y-1/2 rounded-lg border border-white/[0.08] bg-[#0f1216] px-6 py-7 text-center outline-none">
          ...
          >
            <p>Es anónimo — no pedimos cuentas, nombres ni fotos, solo lo que quieras escribir.</p>
            <p>No es un chat — nadie te responde directo, mostramos humanidad real de otras personas.</p>
            <p>
              No reemplaza ayuda profesional — si necesitás hablar con alguien ahora, hay ayuda real en{" "}
              <a
