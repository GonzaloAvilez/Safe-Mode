...
**In** (built, shipped, working today — verified: 139/139 unit tests pass as of 2026-07-16):
...
- Bot/abuse protection (honeypot field + submission-timing check, `lib/bot-protection.ts`)
  — merged `preview` (PR #79, 2026-07-17) then `master` (PR #81, 2026-07-18). Done, both
  branches.
- D10 generative ambient audio (handpan pad) — merged to `master` (PR #80, 2026-07-18).
  Was frozen as of 2026-07-16, actively revived and shipped since. Done.
